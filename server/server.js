...
server.use('/api/test', require('./api/test'));
server.use('/api/themes', require('./api/themes'));
server.use('/api/theme', require('./api/theme'));
server.use('/api/projects', require('./api/projects'));
server.use('/api/project', require('./api/project'));
server.use('/api/toolbox', require('./api/toolbox'));
